...
class _NavigationHostState extends State<NavigationHost> {
  ...
  void initState() {
    ...
    _pages = [
      ...
      const PlaceholderPage(title: 'Explore Screen', icon: Icons.search_rounded),
      ...
      children: [
        ...
        const Text('Sara',
            style: TextStyle(
                ...
                color: Colors.white)),
        const Text('sara24@gmail.com',
            style: TextStyle(color: Colors.white70, fontSize: 16)),
        const SizedBox(height: 40),
        _buildSettingsGroup([
          _buildListTile('My Booking'),
          _buildListTile('My Vehicle'),
          _buildListTile('Payment Method'),
          _buildListTile('Rent your spot', showDivider: false),
        ]),
        const SizedBox(height: 20),
        _buildSettingsGroup([
